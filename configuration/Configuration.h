...
#define MACHINE_UUID "cab8755c-438d-4743-9832-27376041308a"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, 3 }
...
//
#undef HOST_KEEPALIVE_FEATURE        // Disable this if your host doesn't like keepalive messages
